<template>
  <article
    class="group bg-white overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow"
  >
    ...
    <div class="p-4 space-y-2">
      <!-- Title -->
      <h3
        class="text-lg font-semibold text-[#09033b] line-clamp-2 leading-tight"
      >
        <NuxtLink
