...
<p class="text-gray-600 sm:text-lg max-w-md leading-relaxed">
  ...
  <div class="flex flex-col sm:flex-row w-full sm:w-auto items-stretch sm:items-center gap-4 pt-1">
    ...
    <UButton
      ...
      size="lg"
      @click="openWhatsApp"
      class="px-6 py-3 border bg-white border-green-600 justify-center cursor-pointer hover:border-green-900 text-green-600 font-semibold rounded-lg shadow-lg"
    >
      Chat on WhatsApp
    </UButton>
  </div>
